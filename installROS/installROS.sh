...
#installation of custom packages required for F1tenth_Project
sudo apt-get -y install ros-melodic-ros-control
sudo apt-get -y install ros-melodic-gazebo-ros-control
sudo apt-get -y install ros-melodic-ros-controllers
sudo apt-get -y install ros-melodic-navigation
sudo apt-get -y install ros-melodic-navigation qt4-default
sudo apt-get -y install ros-melodic-ackermann-msgs
sudo apt-get -y install ros-melodic-serial
sudo apt-get -y install ros-melodic-teb-local-planner*
